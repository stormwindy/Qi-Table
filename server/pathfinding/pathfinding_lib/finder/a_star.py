...
class AStarFinder(Finder):
    ...
    def check_neighbors(self, table, start, end, grid, open_list,
        ...
        neighbors = self.find_neighbors(grid, node, table)
    ...
    def find_path(self, table, start, end, grid):
        ...
        start.g = 0
        start.f = 0
        return super(AStarFinder, self).find_path(table, start, end, grid)
